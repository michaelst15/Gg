...
ENCRYPT_LOG_VALUE=$(mysql -u root -p'bangtob150420' -N -B -e "SELECT VARIABLE_VALUE FROM information_schema.global_variables WHERE VARIABLE_NAME LIKE '%ENCRYPT_LOG%';" 2>/dev/null)
